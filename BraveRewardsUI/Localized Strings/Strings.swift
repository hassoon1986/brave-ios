...
internal extension Strings {
  ...
  static let WithdrawFunds = NSLocalizedString("BraveRewardsWithdrawFunds", bundle: Bundle.RewardsUI, value: "Withdraw Funds", comment: "")
  ...
  static let UserWalletOnboardingVerifyButtonTitle =  NSLocalizedString("UserWalletOnboardingVerifyButtonTitle", bundle: Bundle.RewardsUI, value: "Verify Wallet", comment: "The button that triggers the Uphold auth process")
  static let UserWalletOnboardingPoweredByUphold =  NSLocalizedString("UserWalletOnboardingPoweredByUphold", bundle: Bundle.RewardsUI, value: "Our wallet service is provided by Uphold", comment: "")
  static let UserWalletOnboardingPoweredByUpholdBoldedWord =  NSLocalizedString("UserWalletOnboardingPoweredByUpholdBoldedWord", bundle: Bundle.RewardsUI, value: "Uphold", comment: "The word that will be bolded in UserWalletOnboardingPoweredByUphold")
  static let UserWalletOnboardingUpholdDisclosure =  NSLocalizedString("UserWalletOnboardingUpholdDisclosure", bundle: Bundle.RewardsUI, value: "Uphold may require you to verify your identity based on services requested.\n\nBrave Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.", comment: "The disclosure about Uphold at the bottom of the screen")
  static let UserWalletUnverifiedButtonTitle =  NSLocalizedString("UserWalletUnverifiedButtonTitle", bundle: Bundle.RewardsUI, value: "Verify Wallet", comment: "")
  static let UserWalletDisconnectedButtonTitle =  NSLocalizedString("UserWalletDisconnectedButtonTitle", bundle: Bundle.RewardsUI, value: "Disconnected", comment: "")
  static let UserWalletVerifiedButtonTitle =  NSLocalizedString("UserWalletVerifiedButtonTitle", bundle: Bundle.RewardsUI, value: "Wallet Verified", comment: "")
  static let UserWalletDetailsTitle = NSLocalizedString("UserWalletDetailsTitle", bundle: Bundle.RewardsUI, value: "User Wallet", comment: "The title in the navigation bar shown when you click on a connected or verified user wallet button")
  static let UserWalletDetailsVerified = NSLocalizedString("UserWalletDetailsVerified", bundle: Bundle.RewardsUI, value: "Verified", comment: "")
